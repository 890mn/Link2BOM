...
var textZh = {
    ...
    "sidebar.import.sheet": "导入 XLS/XLSX/CSV",
    ...
    "archive.name": "存档名称",
    "archive.path": "存档位置",
    "archive.save.ok": "存档已保存",
    "archive.save.fail": "存档保存失败",
    "archive.load.ok": "存档已读取",
    "archive.load.fail": "存档读取失败",
    "archive.overwrite.title": "覆盖存档",
    "archive.overwrite.body": "此存档已有内容，是否覆盖保存？",
    "sidebar.export": "导出",
...
var textEn = {
    ...
    "sidebar.import.sheet": "Import XLS/XLSX/CSV",
    "sidebar.import.ocr": "OCR Import (Later)",
    "sidebar.import.ocr.todo": "OCR flow is not connected yet.",
    "archive.title": "Local Archives",
    "archive.load": "Load",
    "archive.save": "Save",
    "archive.name": "Save name",
    "archive.path": "Save path",
    "archive.save.ok": "Archive saved",
    "archive.save.fail": "Save failed",
    "archive.load.ok": "Archive loaded",
    "archive.load.fail": "Load failed",
    "archive.overwrite.title": "Overwrite Archive",
    "archive.overwrite.body": "This slot already has data. Overwrite it?",
